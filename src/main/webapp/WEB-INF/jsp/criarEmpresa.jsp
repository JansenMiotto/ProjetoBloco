...
<html>
    <head>
        ...
        <title>Ventura HR - Criar Empresa</title>
    ...
    <tr>
      <td width="100%" bgcolor="#808080"><font size="4" color="#FFFFFF"><b>VenturaHR - Empresa</b></font></td>
    </tr>
    <tr>
      <td width="100%">
      <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
        <tr>
          <td valign="top">
          <p align="center"><font size="2"><b>Criação de Conta - Cadastramento de Empresa</b></font></p>
          <div align="center">
            <center>
            <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" id="AutoNumber3">
              ...
              <td align="left"><font size="2">CNPJ:</font></td>
                <td><input type="text" name="cnpj" size="20" class="form-control"></td>
              </tr>
